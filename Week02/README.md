...
To become a trusted software development company that provides reliable, affordable, and innovative IT solutions for businesses.

## Company Mission

ABC Startup Solutions aims to provide quality software and technical services by using reliable technologies, maintaining secure IT infrastructure, and providing responsive support to clients.
...
| -------- | --------------------- | -------: | ------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| HW-001   | Desktop Computer      |       20 | All Departments          | Used by employees for daily work, communication, documentation, software development, finance, HR, and sales activities. |
| HW-002   | Laptop                |        5 | IT and Sales             | Used for meetings, presentations, remote work, troubleshooting, and mobility.                                            |
| HW-003   | Server                |        1 | IT                       | Hosts company services, applications, files, and internal systems.                                                       |
| HW-004   | Router                |        1 | IT                       | Connects the company network to the internet and manages network traffic.                                                |
| HW-005   | Managed Switch        |        1 | IT                       | Connects computers, server, printer, access point, and other network devices.                                            |
| HW-006   | Network Printer       |        2 | Finance and HR           | Provides shared printing for documents, reports, and company records.                                                    |
| HW-007   | UPS                   |        3 | IT                       | Provides power protection for the server, network equipment, and important workstations.                                 |
| HW-008   | Wireless Access Point |        2 | All Departments          | Provides wireless network access throughout the office.                                                                  |
| HW-009   | NAS Storage           |        1 | IT                       | Provides centralized file storage and backup storage.                                                                    |
| HW-010   | External Backup Drive |        2 | IT                       | Stores additional offline backups of important company data.                                                             |
| HW-011   | Monitor               |       20 | IT and Other Departments | Provides display devices for desktop and laptop workstations.                                                            |
...
| ------------------ | ---------------------------- | ----------------------- | ----------------------------------------------------------------- |
| Windows 11 Pro     | Windows 11 Pro 24H2          | Commercial              | Main operating system for employee computers.                     |
| Ubuntu Server      | Ubuntu Server 24.04 LTS      | Open Source             | Used as the company's server operating system.                    |
| Microsoft Office   | Microsoft 365 Apps           | Subscription            | Used for documents, spreadsheets, presentations, and office work. |
| Visual Studio Code | Latest Stable Version        | Free                    | Used by IT employees for programming and software development.    |
| Git                | Latest Stable Version        | Open Source             | Used for source code version control.                             |
| GitHub Desktop     | Latest Stable Version        | Free                    | Provides a graphical interface for Git and GitHub repositories.   |
| VirtualBox         | Version 7.x                  | Open Source             | Used for creating virtual machines for testing and learning.      |
| Google Chrome      | Latest Stable Version        | Free                    | Used for web browsing and accessing web-based business systems.   |
| Microsoft Defender | Included with Windows 11 Pro | Included                | Provides antivirus and security protection for Windows computers. |
| AnyDesk            | Latest Stable Version        | Commercial/Free options | Used by IT staff for remote technical support.                    |
| 7-Zip              | Latest Stable Version        | Open Source             | Used to compress and extract files.                               |

---

# Embedded Network Diagram

The enterprise network infrastructure of ABC Startup Solutions shows how devices and departments are connected from the Internet through the ISP modem, router, firewall, managed switch, and wireless access point.
...
## PAIOS Website
[PAIOS](https://paios-classroom.com/assignment-attachments/13/file)

---

## Microsoft Documentation / Microsoft Learn
...
[Cisco Technical Documentation](https://www.cisco.com/c/en/us/docs/technical-documentation.html) 

---

## CompTIA
[CompTIA Official Website](https://www.comptia.org/en-us/certifications/network/) 

...
1. Microsoft. (n.d.). *Windows Server documentation*. Microsoft Learn.
2. Microsoft. (n.d.). *Microsoft Evaluation Center*.
3. Canonical. (2026). *Ubuntu Server documentation*. Ubuntu.
4. Canonical. (2026). *Ubuntu Server installation guide*.
5. Oracle. (2024). *Oracle VM VirtualBox User Guide*.
6. Oracle. (n.d.). *VirtualBox documentation*.
7. Microsoft. (n.d.). *Boot to UEFI or legacy BIOS mode*.
8. UEFI Forum. *UEFI Specification*.
